...
if __name__ == '__main__':
        ...
        for _ in range(3):
            convergence_metrics = [
                ArchiveLogger(
                    ...
                    base_filename=f"Multi_MORDM_seed_{_}.tar.gz",
                ),
                EpsilonProgress(),
            ]
    ...
    results_epsilon.to_csv('Overijssel MORDM_epsilon_ref_scen.csv', index=False)
    merged_archives.to_csv('Overijssel_MORDM_Policies_ref_scen.csv', index=False)
